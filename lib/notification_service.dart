...
class NotificationService {
  ...
  static Future<void> showNotificationWithReminder(Reminder reminder) async {
    ...
    const AndroidNotificationDetails androidPlatformChannelSpecifics =
        AndroidNotificationDetails(
            ...
            "Notification channel for the car's reminders",
    ...
    await flutterLocalNotificationsPlugin.show(0, reminder.name,
        reminder.notificationText(DateTime.now(), 0), platformChannelSpecifics,
        payload: 'item x');
  }
  ...
  static Future<void> showNotification() async {
    ...
    await flutterLocalNotificationsPlugin
        .show(0, "test", "seees", platformChannelSpecifics, payload: 'item x');
  }
