                      ...
                      Row(
                        children: [
                          ...
                          DropdownButton(
                              value: tireType,
                              items: [
                                DropdownMenuItem(child: Text(S.of(context).tire_type_winter), value: TireType.WINTER),
                                DropdownMenuItem(child: Text(S.of(context).tire_type_summer), value: TireType.SUMMER),
                                DropdownMenuItem(child: Text(S.of(context).tire_type_all_year), value: TireType.ALL_YEAR),
                                DropdownMenuItem(child: Text(S.of(context).tire_type_other), value: TireType.NOT_SPECIFIED),
                              ],
                              onChanged: (val){
                                setState(() {
                                  tireType = val;
