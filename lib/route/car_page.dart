				...
				children: [
					ListTile(leading: Icon(FontAwesomeIcons.gasPump),title: Text("tankolás"),
						onTap: (){
							...
							Navigator.pushNamedAndRemoveUntil(context, "/cars/$id/refuels", (a) => false);
						},
					),
					ListTile(leading: Icon(FontAwesomeIcons.gasPump),title: Text("Szervizek"),
						onTap: (){
							Navigator.pop(context);
							Navigator.pushNamedAndRemoveUntil(context, "/cars/$id/repairs", (a) => false);
						},
					),
					ListTile(leading: Icon(FontAwesomeIcons.gasPump),title: Text("Értesitők"),
						onTap: (){
							Navigator.pop(context);
							Navigator.pushNamedAndRemoveUntil(context, "/cars/$id/reminders", (a) => false);
						},
					),
					ListTile(leading: Icon(FontAwesomeIcons.gasPump),title: Text("Autópálya matricák"),
						onTap: (){
							Navigator.pop(context);
							Navigator.pushNamedAndRemoveUntil(context, "/cars/$id/evignettes", (a) => false);
						},
					),
					ListTile(leading: Icon(FontAwesomeIcons.gasPump),title: Text("Statisztikák"),
						onTap: (){
							Navigator.pop(context);
							Navigator.pushNamedAndRemoveUntil(context, "/cars/$id/statistics", (a) => false);
						},
					),
			...
			child: BlocBuilder<CarBloc, CarState>(
				builder: (context, state){
					if(state is ReadyState){
						return Scaffold(
							appBar: AppBar( title: Text(getCurrentPageTitle(context) + state.car.name),),
							drawer: SafeArea(
